...
import (
	...
	"github.com/hmajid2301/advent_of_code/2023/dayten"
	"gotest.tools/assert"
)

func TestCalculateMaxSteps(t *testing.T) {
	t.Run("Should return loop", func(t *testing.T) {
		mazeStr := `.....
.S-7.
.|.|.
.L-J.
.....`
		...
		value := dayten.CalculateMaxSteps(mazeStr)
		assert.Equal(t, value, 4)
	})
	t.Run("Should return loop complex example", func(t *testing.T) {
		mazeStr := `..F7.
.FJ|.
SJ.L7
|F--J
LJ...`
	...
	t.Run("Should return loop real example", func(t *testing.T) {
		mazeStr := `777FJ.F|-|FFF-L-J7.7.F-7--L-7-L-LF-7-FFF.FLF7.FL7-J77F-7.L7-7.-F77F|FLJ7.L---7.7---J77F|.F|-J7FFF|7-F7-77.FF7|-7-F77F-.J7.777FF|F|-F77|-77.F
