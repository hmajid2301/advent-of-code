...
func TestCalculateCaibrations(t *testing.T) {
	...
	t.Run("Should return calibration values real case", func(t *testing.T) {
		calibrations := `sdpgz3five4seven6fiveh
876mbxbrntsfm
...
func TestCalculateCaibrationsWithString(t *testing.T) {
	t.Run("Should return calibration values", func(t *testing.T) {
		calibrations := `two1nine
eightwothree
abcone2threexyz
xtwone3four
4nineeightseven2
