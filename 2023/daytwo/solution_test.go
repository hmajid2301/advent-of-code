...
func TestCalculatePossibleGames(t *testing.T) {
	t.Run("Should return combined ids", func(t *testing.T) {
		results := `Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
...
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green`
	...
	t.Run("Should return combined ids actual task", func(t *testing.T) {
		results := `Game 1: 7 blue, 5 red; 10 red, 7 blue; 5 blue, 4 green, 15 red; 4 green, 6 red, 7 blue; 5 green, 8 blue, 4 red; 5 red, 4 blue, 3 green
...
Game 100: 1 red, 4 blue, 2 green; 6 red, 2 green, 11 blue; 1 red, 1 blue, 2 green; 1 red, 7 blue`
		...
		value := daytwo.CalculatePossibleGames(results)
		assert.Equal(t, value, 2528)
	})
}

func TestCalculateMinCubes(t *testing.T) {
	t.Run("Should return total of power set", func(t *testing.T) {
		results := `Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green`
		...
		value := daytwo.CalculateMinimumCubes(results)
		assert.Equal(t, value, 2286)
	})

	t.Run("Should return total of power set real example", func(t *testing.T) {
		results := `Game 1: 7 blue, 5 red; 10 red, 7 blue; 5 blue, 4 green, 15 red; 4 green, 6 red, 7 blue; 5 green, 8 blue, 4 red; 5 red, 4 blue, 3 green
Game 2: 8 green, 3 red; 7 blue, 6 red, 8 green; 7 blue, 3 green, 6 red; 8 green, 6 blue, 11 red; 6 blue, 3 green, 12 red
Game 3: 6 blue, 3 red, 7 green; 3 red, 3 green, 8 blue; 8 blue, 11 red, 4 green; 5 blue, 7 red, 6 green; 9 blue, 7 green, 1 red
Game 4: 3 red, 4 green; 5 red, 1 blue; 2 green; 3 green, 1 blue; 2 green, 1 blue, 1 red
