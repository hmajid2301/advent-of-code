...
.664.598..`
	...
	t.Run("Should return sum of part numbers numbers edge case", func(t *testing.T) {
		results := `467..114..
...*......
..35...633
.......#..
...
.664.598..`
	...
	t.Run("Should return sum of part numbers real example", func(t *testing.T) {
		results := `...733.......289..262.....520..................161.462..........450.........................183.............................................
...
.....................244....6.....................................789......................687..............................................`
		...
		value := daythree.CalculatePartNumSum(results)
		assert.Equal(t, value, 525181)
	})

	t.Run("Should return gear ratio", func(t *testing.T) {
		results := `467..114..
...*......
..35..633.
......#...
...
.664.598..`
		...
		value := daythree.CalculateGearRatio(results)
		assert.Equal(t, value, 467835)
	})

	t.Run("Should return gear ratio real example", func(t *testing.T) {
		results := `...733.......289..262.....520..................161.462..........450.........................183.............................................
....*....................*.............707.352....*............/.....................801...@...............333..196........484.635......287.
....42.........131....913..............*......&..........634..................440..&...............83.....@...........404$..=....*..423.*...
618.......272....*.........&......547.344...............#............689.589.*....150......382=................................168......433.
